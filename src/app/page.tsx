...
export default async function Home(){
 ...
 <section className="care-hero" aria-labelledby="hero-title"><div className="hero-copy"><span className="hero-label"><span/> HEALTHCARE, ON YOUR TERMS</span><h2 id="hero-title">Find care.<br/><em>Feel in control.</em></h2><p>Find a doctor, plan your next visit, and take care of what matters. All in one place.</p><Link className="btn hero-button" href="/doctors">Find your care <ArrowUpRight size={19}/></Link></div><CarePath/></section>
